    ...
    >
      <div className={`h-12 md:h-14 flex items-center justify-between px-4 md:px-5 ${theme === 'dark' ? 'bg-gray-800/50 border-b border-gray-700' : 'bg-gray-100 border-b border-gray-200'}`}>
        ...
        <div className="flex gap-1.5 md:gap-2">
          <label className={`p-1.5 md:p-2 rounded-lg cursor-pointer transition-colors ${theme === 'dark' ? 'hover:bg-gray-700' : 'hover:bg-gray-200'}`}>
      ...
      <textarea
        ...
        className={`w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] p-4 md:p-6 font-mono text-xs sm:text-sm resize-none focus:outline-none ${
